...
CATLOGO = "https://telegra.ph/file/88b355899c7f69172dacc.jpg"
...
async def inline_handler(event):  
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        buttons = [
            (
                Button.url("Source code", "https://github.com/Karimgamal12/teleAvsource7"),
                Button.url(
                    "Deploy",
        ...
        result = types.InputBotInlineResult(
            ...
            url="https://dashboard.heroku.com/new?template=https://github.com/Karimgamal12/teleAvsource7",
            thumb=photo,
            content=photo,
            send_message=types.InputBotInlineMessageMediaAuto(
                reply_markup=markup, message=text, entities=msg_entities
