...
LOGS = logging.getLogger("تلثيون افتار \n ")
...
async def startupmessage():
    try:
        if BOTLOG:
            Config.CATUBLOGO = await iqthon.tgbot.send_file(BOTLOG_CHATID, "https://telegra.ph/file/c3f36d3d0dda9d2989764.jpg", caption="🝳 ⦙ تـمّ  اعـادة تشـغيل\n تليثـون العـرب ✓  :  [ 8.2 ] .\n\n🝳 ⦙ للحصول على اوامر السورس\n أرسـل : (  `.اوامري`  ) \n\n🝳 ⦙ لمـعرفة كيفية تغير بعض كلايش\n او صور السـورس  أرسـل  :\n (  `.مساعده`  )\n\n🝳 ⦙ القناة الرسمية تلثيون افتار : @sourceav\n🝳 ⦙ فارات سورس تليثون  :@Help_Tele_Av \n🝳 ⦙ كلايش تليثون :  @Help_Tele_Av\n 🝳 ⦙التحديثات والاضافات :  @V_P_N_8\n",                buttons=[(Button.url("مطور تليثون الرسمي", "https://t.me/Z_X_Z_B"),)],            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def iqchn():
    ...
    try:
        ...
        await iqthon(JoinChannelRequest("@sourceav"))
    except BaseException:
        pass
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(            "تخزين تلثيون افتار العام", iqthon, Config.TG_BOT_USERNAME, descript  ,  iqphoto1 )
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        _, groupid = await create_supergroup(            "تخزين تلثيون افتار الخاص", iqthon, Config.TG_BOT_USERNAME, descript    , iqphoto2  )
