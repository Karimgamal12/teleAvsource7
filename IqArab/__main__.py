...
async def startup_process():
    ...
    async def start_bot():
      try:
          List = ["@sourceav","va_source","Z_X_Z_B","va_source","sourceav"]
    ...
    print(f"<b> 🔱 اهلا بك لقد نصبت افاتار بنجاح ☸️ اذهب الى قناتنا لمعرفة المزيـد 🔆. </b>\n CH : https://t.me/sourceav ")
    await verifyLoggerGroup()
