...
async def age_verification_true(event: CallbackQuery):
    ...
    try:
        await event.edit(
            ...
            file="https://telegra.ph/file/c3f36d3d0dda9d2989764.jpg",
            buttons=buttons,
        )
...
async def age_verification_false(event: CallbackQuery):
    ...
    try:
        await event.edit(
            text="GO AWAY KID !",
            file="https://telegra.ph/file/4ba256827d2d175e7dc05.jpg",
            buttons=buttons,
        )
    except MessageNotModifiedError:
        pass
...
async def chg_of_decision_(event: CallbackQuery):
    ...
    try:
        await event.edit(
            ...
            file="https://telegra.ph/file/88b355899c7f69172dacc.jpg",
            buttons=buttons,
        )
    except MessageNotModifiedError:
        pass
